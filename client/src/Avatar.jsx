...
const Avatar = ({username, userId, online}) => {
    ...
    const colors = ['bg-red-200', 'bg-green-200', 'bg-yellow-200', 'bg-blue-200', 'bg-purple-200', 'bg-gray-200'];
    ...
    return (
        <div className = {"w-8 h-8 relative rounded-full flex items-center " + color}>
            <div className = "text-center w-full font-bold text-purple-800">{username[0]}</div>
            {online && (
